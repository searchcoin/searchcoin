...
UniValue fTimestampIndex(const UniValue& params, bool fHelp)
{
...
UniValue getblockhashes(const JSONRPCRequest& request )//const UniValue& params, bool fHelp)
{
...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of searchcoin addresses\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "blockchain",         "getblockhashes",         &getblockhashes,         true,  {"start","end"} },
