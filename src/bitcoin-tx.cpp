...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s searchcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  searchcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded searchcoin transaction") + "\n" +
              "  searchcoin-tx [options] -create [commands]   " + _("Create hex-encoded searchcoin transaction") + "\n" +
              "\n";
