...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/searchcoin/searchcoin>";
    const std::string URL_WEBSITE = "<http://www.searchcoin.co.kr>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Searchcoin version %s\n", FormatFullVersion());
}
